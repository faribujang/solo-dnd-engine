...
Built to [`SPEC.md`](./SPEC.md). The world it is being built for is [`WORLD.md`](./WORLD.md). **The engine and the server are complete: 363 tests, byte-identical replay.**
...
tests/          363 tests, including every phase gate
saves/          gitignored
```
