...
Built to [`SPEC.md`](./SPEC.md). **The engine is complete: 257 tests, byte-identical replay.**
What remains is the client and the world — see [`HANDOFF.md`](./HANDOFF.md).
...
tests/          257 tests, including every phase gate
saves/          gitignored
```
