...
function renderSystem(s: GameState): string {
  return [
    ...
    "5. Second person, present tense. ONE paragraph, two at the most, and under 120 words",
    "   unless something genuinely large just happened. A player has to hold all of this in",
    "   their head to decide what to do next; if they have to read it twice, it was too",
    "   long. Cut atmosphere before you cut information. End on the situation, not on a",
    "   question, and never on a list of options.",
    "5b. Lead with what CHANGED. The room was described when they walked in; do not set the",
    ...
    "5c. At most one sentence of scenery per reply. Two adjectives in a row is one too many.",
